...
from api.views import FuelPriceFilterView, CarFuelStatsView, index, diesel_policy, datasets_page, policies, CPIReportAPI, cpi_impact, cpi_dataset,set_language, IPI1DDataView, IPIDataView, ManufacturingDivisionsDataView
